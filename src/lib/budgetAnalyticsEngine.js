// Moteur PUR d'ANALYSE BUDGÉTAIRE : PRÉVISIONS (temps écoulé, projection fin
// d'année, recouvrement des frais). Aucune I/O → testable.
//
// Note (P7) : le calcul du « budget global consolidé » (ex-`globalBudget`) et le
// « top des postes de dépense » (ex-`topExpenseChapters`) ont été RETIRÉS — ils
// reposaient sur l'ancien champ plat `budgets.sector` et sont remplacés par le
// moteur hiérarchique P2 (budgetHierarchyEngine : computeHierarchy/nodeConsumption),
// désormais SEULE référence pour budget global / disponible / engagé / payé / taux.
