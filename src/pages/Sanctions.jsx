...
// La séquence rattachée alimente automatiquement les compteurs de conduite du
// bulletin (voir scEngine.vieScolaireAutoConduite, appliqué depuis /app/conseil).
...
export default function Sanctions() {
  ...
  return (
    <RecordsPage
      ...
      defaults={{ action_type: 'avertissement_oral', sequence_order: activeSequence }}
      fields={[
